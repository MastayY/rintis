...
Route::get('/products/detail/{slug}', \App\Livewire\Product\Detail::class)->name('products.detail');

Route::get('/categories', \App\Livewire\Categories\Index::class)->name('categories.index');
Route::get('/categories/{slug}', \App\Livewire\Categories\Detail::class)->name('category.show');

Route::get('/profile/{username}', \App\Livewire\Profile\Index::class)->name('profile.show')->where('username', '[A-Za-z0-9_]+');;
...
Route::middleware(['auth'])->group(function (): void {
    ...
    // Products
    Route::get('/products/create', \App\Livewire\Product\CreateProduct::class)->name('products.create');
